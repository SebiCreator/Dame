...
class MatrixSpec extends AnyWordSpec with Matchers {
  ...
  formatText(
    ...
    player1 should be("Player1(A)")
    val player2 = default.numToPlayer(2)
    player2 should be("Player2(B)")
  }
  /*
  formatText("tup returns the Board Data as tuples for printing and") in {
    val default = new Matrix().initFill()
  ...
  formatText(
    ...
    matrix.initFill()
    matrix.moveLeftL(4, 1).getData() should be(List(0, 0, 0, 2, 0, 2))
  }
  ...
  formatText(
    ...
    matrix.moveLeftU(1, 1).getData() should be(List(1, 0, 1, 0, 1, 0))
  }
  ...
  formatText(
    ...
    val matrix = new Matrix().initFill()
    matrix.moveRightU(1, 1).getData() should be(List(0, 0, 0, 0, 0, 0))
  }
  formatText(
    "moveLeftU if possible moves the upper player to the right"
  ) should {
    val matrix = new Matrix().initFill()
    matrix.moveRightL(4, 2).getData() should be(List(0, 0, 0, 0, 0, 0))
  }
   */
  ...
  formatText(
    ...
    val killMatrixRU =
      testMatrix.killRightU(1, 2).getData() should be(
        List(
          List(0, 1, 0, 1, 0, 1),
          List(1, 0, 0, 0, 1, 0),
          List(0, 0, 0, 0, 0, 0),
    ...
    val killMatrixLU =
      testMatrix.killLeftU(1, 0).getData() should be(
        List(
          List(0, 1, 0, 1, 0, 1),
          List(0, 0, 1, 0, 1, 0),
          List(0, 0, 0, 0, 0, 0),
    ...
    val killMatrixLL =
      testMatrix.killLeftL(4, 5).getData() should be(
        List(
          List(0, 1, 0, 1, 0, 1),
          List(1, 0, 1, 0, 1, 0),
          List(0, 2, 0, 2, 0, 0),
    ...
    val killMatrixRL =
      testMatrix.killRightL(4, 3).getData() should be(
        List(
          List(0, 1, 0, 1, 0, 1),
          List(1, 0, 1, 0, 1, 0),
          List(0, 2, 0, 0, 0, 2),
